...
CREATE TABLE `eric_dosa_tbsemi_firstday` (
  ...
  `sch_semi` tinyint(2) unsigned DEFAULT NULL COMMENT '學期',
...
CREATE TABLE `eric_dosa_staff_link` (
  ...
  `name` varchar(255) DEFAULT NULL COMMENT '網站姓名',
...
CREATE TABLE `eric_dosa_staff_jobtitle` (
  ...
  `job_title_code` smallint(4) unsigned DEFAULT NULL COMMENT '職銜代碼',
  `eric_dosa_check` tinyint(3) unsigned DEFAULT NULL COMMENT '身份代碼',
  `tutor_cls_stdno` varchar(255) DEFAULT NULL COMMENT '員工姓名',
  `leave_date` date DEFAULT NULL COMMENT '離校日期',
  PRIMARY KEY (`sn`)
) ENGINE=MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci;

CREATE TABLE `eric_dosa_content`  (
  `sn` mediumint(7) UNSIGNED NOT NULL AUTO_INCREMENT,
  `item_sn` mediumint(7) unsigned DEFAULT NULL COMMENT '原始編號',
  ...
  `std_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '學生姓名',
  `staff_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '登錄人員',
  `item_no` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '項目代碼',
  `item` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '登記項目',
  `weeks` tinyint(2) UNSIGNED NULL DEFAULT NULL COMMENT '周別',
  `sch_year` tinyint(3) UNSIGNED NULL DEFAULT NULL COMMENT '學年',
  `sch_semi` tinyint(2) UNSIGNED NULL DEFAULT NULL COMMENT '學期',
  `item_date` date NULL DEFAULT NULL COMMENT '登記日期',
  `item_time` datetime(0) NULL DEFAULT NULL COMMENT '登記時間',
  `item_freq` tinyint(3) unsigned DEFAULT NULL COMMENT '次數',
  `period` tinyint(2) unsigned DEFAULT NULL COMMENT '節次',
  `input_std_no` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '登錄學生學號',
  `rec_std_no` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '評分學生學號',
  `cate_no` tinyint(3) UNSIGNED NULL DEFAULT NULL COMMENT '種類代碼',
  `cate_txt` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `score` float(2, 2) NULL DEFAULT NULL,
...
CREATE TABLE `eric_dosa_tbsimpledata`  (
  `serial_no` mediumint(7) UNSIGNED NOT NULL AUTO_INCREMENT,
  `std_No` varchar(255)  NOT NULL DEFAULT '' COMMENT '學生學號',
  `dept` varchar(255)  NULL DEFAULT NULL COMMENT '部別',
  `grade` varchar(255) NULL DEFAULT NULL  COMMENT '年級別',
  `eclass` varchar(255)  NULL DEFAULT NULL COMMENT '英文班別',
  `stdname` varchar(255)  NULL DEFAULT NULL  COMMENT '學生姓名',
  `seat` tinyint(2) UNSIGNED NULL DEFAULT 0 COMMENT '座號',
  `c_class` varchar(255)  NULL DEFAULT NULL  COMMENT '中文班別',
  `classseat` varchar(255)  NULL DEFAULT NULL	 COMMENT '班別座號',
  `rec_date` date NULL DEFAULT NULL COMMENT '入檔日期',
  `check_code` varchar(255)  NULL DEFAULT NULL	 COMMENT '驗證碼',
  `pass` varchar(255)  NULL DEFAULT NULL	 COMMENT 'pass',
  `Memo` varchar(255)  NULL DEFAULT NULL COMMENT '備註',
