<div class="container-fluid">
  ...
  <form>
    ...
    <select
      ...
      onchange="location.href='main.php?op=cate_counts&weeks=' + this.value"
    >
    ...
    <tbody>
      ...
      <tr>
        <td class="text-center">
          <a
            href="main.php?op=eric_dosa_list&weeks=<{$eric_dosa_cate_counts.weeks}>&eclass=<{$eric_dosa_cate_counts.eclass}>"
            class="text-primary"
